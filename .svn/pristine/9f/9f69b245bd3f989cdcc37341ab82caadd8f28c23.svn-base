			...
			<div class="form-group">
				<div class="col-sm-12" style="text-align:center">
					...
					<label class="col-sm-1 control-label no-padding-right">
						<button class="btn btn-sm btn-primary">办结确认</button>			
					</label>
					<label class="col-sm-1 control-la2bel no-padding-right">
					...
					<label class="col-sm-1 control-label no-padding-right" style="text-align:center">									
						<button class="btn btn-sm btn-danger">不予办结</button>
					</label>
					<label class="col-sm-2 control-label no-padding-right">
